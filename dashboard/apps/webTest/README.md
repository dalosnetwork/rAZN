...
- **Tooling & DX**: TypeScript, npm scripts  
...
This project currently has no bundled formatter/linter configuration.
Use your preferred tools (for example ESLint + Prettier) if you want automated style checks.
